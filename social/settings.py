...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.main.views.menu',
                'apps.main.views.userprofile',
                'apps.parameter.views.site_settings',
                'apps.content.views.shared_post',
                'apps.content.views.Message',

                'apps.content.views.events'
